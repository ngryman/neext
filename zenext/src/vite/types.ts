...
export interface Manifest {
  ...
  declarative_net_request?: {
    rule_resources: chrome.declarativeNetRequest.Ruleset[]
  }
  ...
  optional_permissions?: chrome.runtime.ManifestPermissions[]
  options_page?: string
  options_ui?: {
    page?: string
...
export type ChromeManifestBackground = {
  service_worker: string
  type?: 'module'
}

export type WebAccessibleResourceById = {
  extension_ids: string[]
  resources: string[]
  use_dynamic_url?: boolean
}

export type WebAccessibleResourceByMatch = {
  matches: string[]
  resources: string[]
  use_dynamic_url?: boolean
}
